...
#'return(LDheatmap)
#'}}
#'environment(LDheatmap.addScatterplot2) <- asNamespace('LDheatmap')
#' 
#' @keywords hplot
#' @export
...
LDheatmap.addScatterplot2 <- function(LDheatmap, P, height=0.2, ylab=NULL, ylim=NULL, type="points") {
  ...
  association2 <- gTree(children=gList(xaxis, yaxis, yaxisT, ylab), name="association2", vp=vpstack)
  ...
  LDheatmap$LDheatmapGrob <- addGrob(LDheatmap$LDheatmapGrob, association2)
